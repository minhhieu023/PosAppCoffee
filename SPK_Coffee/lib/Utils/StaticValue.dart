...
class StaticValue {
  ...
  static String svPath = 'https://hieuit.tech:8001/uploads/';
}

Map workColor = {
  'open': Colors.white,
  'processing': Colors.yellowAccent[100],
