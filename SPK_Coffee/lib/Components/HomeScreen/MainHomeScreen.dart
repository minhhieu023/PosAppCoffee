            ...
            Container(
              ...
              child:
                  ...
                  Column(
                    ...
                    children: [
                     Padding( padding: EdgeInsets.only(top: 20, left: 20), child: Text("Wellcome back", style: TextStyle(fontSize: 18)),),
                      Row(children: [
                        Container(
                        ...
                        Text("Võ Minh Hiếu",style: TextStyle(fontSize: 20, fontWeight:  FontWeight.bold)),
                      ],)
                    ],
                  ),
    ),
